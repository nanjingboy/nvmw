...
program
    ...
    .description('build and install the given version of Node');
program
    .command('uninstall <version>')
    .description('uninstall the given version of Node');
program
    .command('use <version>')
    .description('use the specified Node in current shell');
program
    .command('ls')
    .description('list the installed all Nodes').action(function() {
...
program
    .command('deactivate')
    .description('undo effects of nvmw on current shell');
